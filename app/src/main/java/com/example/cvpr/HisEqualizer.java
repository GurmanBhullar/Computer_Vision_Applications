...
public class HisEqualizer extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_his_equalizer);

        cameraBridgeViewBase = (JavaCameraView) findViewById(R.id.HisequalView);
