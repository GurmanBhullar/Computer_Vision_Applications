...
public class Sobel_edge extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sobel_edge);

        cameraBridgeViewBase = (JavaCameraView) findViewById(R.id.SobelView);
    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        Imgproc.Sobel(grey,grey,-1,1,1,5);
