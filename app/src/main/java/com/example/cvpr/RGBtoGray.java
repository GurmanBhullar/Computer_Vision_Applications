...
public class RGBtoGray extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rgbto_gray);

        cameraBridgeViewBase = (JavaCameraView) findViewById(R.id.GrayView);
